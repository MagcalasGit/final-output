...
namespace ordersystem
{
    public partial class frm_item : Form
    {
        ...
        {
            if (!int.TryParse(txt_Chick.Text, out _))
            {
                MessageBox.Show("Please enter a valid integer for Fried Chicken quantity.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txt_Chick.Text = "0";
            }
        }
        ...
        {
            if (!int.TryParse(txt_quesa.Text, out _))
            {
                MessageBox.Show("Please enter a valid integer for Fried Chicken quantity.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txt_quesa.Text = "0";
            }
        ...
        {
            if (!int.TryParse(txt_bigmac.Text, out _))
            {
                MessageBox.Show("Please enter a valid integer for Fried Chicken quantity.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txt_bigmac.Text = "0";
            }
        ...
        {
            if (!int.TryParse(txt_cola.Text, out _))
            {
                MessageBox.Show("Please enter a valid integer for Fried Chicken quantity.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txt_cola.Text = "0";
            }
        ...
        {
            if (!int.TryParse(txt_DrPep.Text, out _))
            {
                MessageBox.Show("Please enter a valid integer for Fried Chicken quantity.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txt_DrPep.Text = "0";
            }
        ...
        {
            if (!int.TryParse(txt_Peps.Text, out _))
            {
                MessageBox.Show("Please enter a valid integer for Fried Chicken quantity.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txt_Peps.Text = "0";
            }
        ...
        {
            if (!int.TryParse(txt_Tea.Text, out _))
            {
                MessageBox.Show("Please enter a valid integer for Fried Chicken quantity.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txt_Tea.Text = "0";
            }
        ...
        {
            if (!int.TryParse(txt_tacbur.Text, out _))
            {
                MessageBox.Show("Please enter a valid integer for Fried Chicken quantity.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txt_tacbur.Text = "0";
            }
        ...
        private void btn_proceed_Click(object sender, EventArgs e)
        {
            ...
            //Open frm_summary and passing the vairables
